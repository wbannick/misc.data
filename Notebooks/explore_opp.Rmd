...
Search and arrest rates are also generally higher in Oakland and San Jose than San Francisco. Perhaps policy officers feel more unsafe in areas with higher populations of Black and Brown people and are more likely to search and arrest people of any race in these areas than they would in other areas. As for much of this analysis, neighborhood data would be helpful here. The OPP stop data in these cities does include Lat/Long data, so a finer analysis is possible.

In an attempt to control for other factors than race and city, I ran two logistic regression models, the coefficients of which are plotted below. I dropped San Jose data from the models, because gender was not recorded.  As is evident there is not a lot of information that we might want to control for. 
<br>
<br>
...
In particular, I would like to introduce measures of age, income, and racial composition of the area into the model. Since this data does have lat/long coordinates, some of this could theoretically be gathered and estimated at smaller geographical levels and be harnessed to improve the models.

While limited, these models do bolster our earlier findings. When gender, season, and city are controlled for, the coefficients with the greatest positive magnitudes are still indicator variables for being Black or Hispanic. Meaning that being Black, and to a lesser extent Hispanic, are the factors shown to most dramatically impact one’s likelihood of being searched and arrested when one is subject to a traffic stop. People in Oakland are also more likely to be searched and arrested, as are men. A further analysis of interactions of some of these variables would be a logical next step.

## Addressing Alternative Outcome Analysis

I have seen others argue that an evaluation of whether or not a stop is discriminatory consider whether or not an arrest was made or if contraband was found. There are many ways to explore these concepts, but they are based on deeply flawed assumptions. The stop data we have access to is recorded by Police officers. As for all data, it should not be treated as a neutral or unbiased truth. As we have seen in very public examples of incidents where

To put it plainly, I will not entertain arguments that Black and Brown people are more likely to commit crimes, or be in the possession of drugs. Rather, I believe the racist condidtioning and stereotypes we have been constantly confronted with make police officers treat Black and Brown people with predjudice in every component of a traffic stop including the decision on whether or not to stop the individual, the decision whether or not to search an individual, the decision about what contraband is “acceptable” the decision of whether to warn or arrest an individual and the decision of whether or not to plant or alter evidence. Isolating how these decisions alter the records police take is very difficult to do. This racist conditioning certainly does not only effect police. It is the same mechanism functioning when the rest of us make decisions like whether to not to call the police and how we interact with strangers and friends.

That disclaimer is not meant to hypocritically imply that an analysis of this data is useless. Its purpose was to briefly address some arguments made to excuse and justify discriminatory stop patterns and to briefly articulate why I decided an exploration of a research question which essentially amounts to “are Black and Latinx folks more likely to commit crime and should they therefore be stopped more” was not worth focusing on.

## Looking Forward

There are many directions in which one could continue this analysis, and I amy come back to this and dig deeper, but the purpose of this analysis has been to provide a brief data-informed overview of discriminatory policing in Bay Area cities. Being a “liberal” or “progressive” area does not immunize are systems from racism and discrimination. In my experience many white families and educators from liberal areas latch on to notions that racism and discriminatory systems are much worse in other regions of the country in a way that defects blame and reflection to other people and excuses ignorance and apathy. I hope that information and discussions such as those in this brief post can helps us reflect more honestly with the areas and systems we interact with.
